...
function CarDetails() {
  ...
  // const features = ["360° Camera", "Bluetooth", "GPS Navigation", "Heated Seats", "Rear View Camera", "Cruise Control", "Sunroof", "Leather Seats"];
    ...
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-2">
          <img src={car.image} alt="" className="w-full h- md:max-h-100 object-cover rounded-xl mb-6 shadow-md" />
